...
public class Main {
    ...
    private static void inicializaMonstruos(){
        ...
        monstuos[0] = new Monstruo(new ArrayList<Integer>(Arrays.asList(1,2)),"123","a");
        monstuos[1] = new Monstruo(new ArrayList<Integer>(Arrays.asList(1,2)),"dcd","a");
        monstuos[2] = new Monstruo(new ArrayList<Integer>(Arrays.asList(1,0)),"ew","a");
        monstuos[3] = new Monstruo(new ArrayList<Integer>(Arrays.asList(2)),"43r","a");
        monstuos[4] = new Monstruo(new ArrayList<Integer>(Arrays.asList(0)),"4r","a");
    }
